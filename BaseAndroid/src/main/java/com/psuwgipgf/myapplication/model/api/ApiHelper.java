...
public class ApiHelper {
	...
	public static Response get(String url, Map<String, String> params) {
		Response response = OkHttpManager.getRequest().url(url)
		.setParams(params).exec();
		return response;
	}

	public static Response post(String url, Map<String, String> params) {
		Response response = OkHttpManager.postRequest().url(url)
		.setParam(params).exec();
		return response;
	}

	public static Response postFile(String url, Map<String, Object> p,
		String arrkey, List<Object> arr) {

		Response response = OkHttpManager.postFileRequest().url(url)
		.setParam(p).addParams(arrkey, arr).exec();
		return response;
	}
